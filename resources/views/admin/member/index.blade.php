                ...
                <tbody>
                    @foreach($member as $key => $rows)
                        <tr data-entry-id="{{ $rows->id }}">
                            ...
                            <td>
                                @can('member_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.master-member.show', $rows->id) }}">
                                        <i class="fa fa-eye"></i> {{ trans('global.view') }}
                                    </a>
                                @endcan
                                @can('member_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.master-member.edit', $rows->id) }}">
                                        <i class="fa fa-edit"></i> {{ trans('global.edit') }}
                                    </a>
                                @endcan
                                @can('member_delete')
                                    
                                    <form action="{{ route('admin.master-member.destroy', $rows->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
