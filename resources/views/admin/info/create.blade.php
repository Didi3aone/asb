...
<div class="card">
    ...
    <div class="card-body">
        <form class="form-material mt-4" action="{{ route("admin.info.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class ="form-control my-editor" name="content" value="{{ old('alamat', isset($user) ? $member->alamat : '') }}" id="content"> </textarea>
