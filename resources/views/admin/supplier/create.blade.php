...
<div class="card">
    ...
    <div class="card-body">
        <form class="form-material mt-4" action="{{ route("admin.supplier.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
                <label for="password">{{ trans('cruds.suppliers.fields.password') }}*</label>
