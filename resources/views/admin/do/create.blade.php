...
<div class="card">
    <div class="card-header bg-warning">
        {{ trans('global.create') }} {{ trans('cruds.do.title') }}
    </div>

    <div class="card-body">
        <form class="form-material mt-4" action="{{ route("admin.do.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="tipe" value="1">
            <div class="form-group {{ $errors->has('no_trx') ? 'has-error' : '' }}">
                <label for="no_trx">{{ trans('cruds.do.fields.nomor_transaksi') }}*</label>
            ...
            <div class="form-group {{ $errors->has('custid') ? 'has-error' : '' }}">
                <label for="roles">{{ trans('cruds.do.fields.custid') }}*</label>
                <select name="custid" id="custid" class="form-control select2" required style="width: 100%; height:36px;">
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group {{ $errors->has('send_date') ? 'has-error' : '' }}">
                        <label for="send_date">{{ trans('cruds.do.fields.send_date') }}*</label>
                        <input type="text" id="send_date" name="send_date" class="form-control date" value="{{ old('send_date', date('Y-m-d')) }}">
                ...
                <div class="col">
                    <div class="form-group {{ $errors->has('receive_date') ? 'has-error' : '' }}">
                        <label for="receive_date">{{ trans('cruds.do.fields.receive_date') }}*</label>
            ...
            <div class="form-group">
                <table class="table table-bordered">
                    <thead>
                    <tr>
                        <th style="width:15%;">{{ trans('cruds.do.fields.product') }}</th>
                        <th style="width:8%;">{{ trans('cruds.do.fields.qty') }}</th>
                        {{-- <th>{{ trans('cruds.do.fields.nomor_sparepart') }}</th> --}}
                        <th>&nbsp;</th>
                    </tr>
                    </thead>
                    <tbody id="items">
                    ...
                    {{-- <tfoot>
                        ...
                        <tr>
                            <td colspan="2"></td>
                            <td>{{ trans('cruds.do.fields.disc') }}</td>
                            <td>
            ...
            <div>
                ...
                <a href="{{ route('admin.do.index') }}" class="btn btn-default"> 
