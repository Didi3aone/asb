...
<div class="card">
    <div class="card-header bg-primary">
        {{ trans('global.create') }} {{ trans('cruds.transaction-stock.title_transaction_out') }}
    </div>

    <div class="card-body">
        <form class="form-material mt-4" action="{{ route("admin.transaksi-store-out") }}" method="POST" enctype="multipart/form-data">
            @csrf
