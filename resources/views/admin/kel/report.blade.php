...
<head>
    ...
    <title> {{ trans('global.report') }} {{ trans('cruds.kelurahan.title_singular') }} {{ $title->name }}</title>
    <!-- DataTables -->
...
<body>
    <div class="card">
        ...
        <center> {{ trans('global.report') }} {{ trans('cruds.kelurahan.title_singular') }} {{ $title->name }}</center>
        </div>
        <div class="card-body">
            <div class="mb-2">
